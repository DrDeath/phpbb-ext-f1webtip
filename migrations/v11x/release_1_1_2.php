...
class release_1_1_2 extends \phpbb\db\migration\migration
{
	...
	{
		return isset($this->config['drdeath_f1webtip_version']) && version_compare($this->config['drdeath_f1webtip_version'], '1.1.2', '>=');
	}
	...
	public function update_data()
	{
		return array(
			...
			array('config.update', array('drdeath_f1webtip_version', '1.1.2')),
		);
	}
}
