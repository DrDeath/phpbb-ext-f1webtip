...
$lang = array_merge($lang, array(
	...
	'FORMEL_TIPP_DELETED'			=> 'Tipp was removed<br /><br />Click %shere%s to go back to the tips overview<br /><br />Click %shere%s to go to forum',
	...
	'FORMEL_ACCEPTED_TIPP'			=> 'You tipp was accepted<br /><br />Click %shere%s to place more tips<br /><br />Click %shere%s to go back to forum',
	...
	'FORMEL_RULES_GENERAL_EXP'		=> 'Here you can show other community members whos really owns the Formula 1.<br /><br />For every race you can place a tipp and collect points. If you are away for a long time, you can now enter your tips for as many races as you want and change it whenever you want. To see the current ranking just visit the statistics page. If you want to know what the other tippers tipped, just click on their usernames on the overview page ( Tips are only shown if the deadline was reached )',
