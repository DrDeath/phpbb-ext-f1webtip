...
class season_update_2014 extends \phpbb\db\migration\migration
{
	...
	public function season_2014($value)
	{
		...
		if ($this->db_tools->sql_table_exists($table_races))
		{
			...
			$sql_ary[] = array('race_id' => 16, 'race_name' => 'Russland / Sochi', 				'race_img' => '', 'race_quali' => '0', 'race_result' => '0', 'race_time' => 1413111600, 'race_length' => '5,853', 'race_laps' => 53, 'race_distance' => '',        'race_debut' => 2014,);
