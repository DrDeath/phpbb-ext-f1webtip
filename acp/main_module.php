            ...
            case 'drivers':
                ...
                if ($button_adddriver || ($button_edit && $driver_id != 0) || ($button_add && $drivername == '')) {
                    ...
                    while ($row = $db->sql_fetchrow($result)) {
                        ...
                        $template->assign_block_vars(
                            ($config['drdeath_f1webtip_show_gfx'] == 1) ? 'driverrows_gfx' : 'driverrows',
                            [
            ...
            case 'teams':
                ...
                if ($button_addteam || ($button_edit && $team_id != 0) || ($button_add && $teamname == '')) {
                    ...
                    while ($row = $db->sql_fetchrow($result)) {
                        ...
                        $template->assign_block_vars(
                            ($config['drdeath_f1webtip_show_gfx'] == 1) ? 'teamrows_gfx' : 'teamrows',
                            [
                                'POINTS'		     => $points,
                                'TEAM_PENALTY'	=> $team_penalty,
                                'TEAMCAR'		    => $team_car,
            ...
            case 'races':
                ...
                if ($button_addrace || ($button_edit && $race_id != 0) || ($button_add && $racename == '')) {
                    ...
                    while ($row = $db->sql_fetchrow($result)) {
                        ...
                        $template->assign_block_vars(
                            ($config['drdeath_f1webtip_show_gfxr'] == 1) ? 'racerows_gfxr' : 'racerows',
                            [
