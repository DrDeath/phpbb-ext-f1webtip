...
class season_update_2021 extends \phpbb\db\migration\migration
{
	...
	public function season_2021()
	{
		...
		if ($this->db_tools->sql_table_exists($table_races))
		{
			...
			$sql_ary[] = ['race_id' => 16, 'race_name' => 'Singapur / Singapur',			'race_img' => '', 'race_quali' => '0', 'race_result' => '0', 'race_time' => 1633262200, 'race_length' => '5,065', 'race_laps' => 61, 'race_distance' => '308,828', 'race_debut' => 2008,];
