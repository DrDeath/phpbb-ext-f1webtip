...
class season_update_2019 extends \phpbb\db\migration\migration
{
	...
	public function season_2019($value)
	{
		...
		if ($this->db_tools->sql_table_exists($table_races))
		{
			...
			$sql_ary[] = array('race_id' => 8,  'race_name' => 'Frankreich / Le Castellet', 	'race_img' => '', 'race_quali' => '0', 'race_result' => '0', 'race_time' => 1561295400, 'race_length' => '5,759', 'race_laps' => 53, 'race_distance' => '310,633', 'race_debut' => 1971,);
